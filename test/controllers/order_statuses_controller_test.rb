...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post order_statuses_url, params: { order_status: { account_id: @order_status.account_id, description: @order_status.description, name: @order_status.name, status: @order_status.status, uid: @order_status.uid } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { account_id: @order_status.account_id, description: @order_status.description, name: @order_status.name, status: @order_status.status, uid: @order_status.uid } }
